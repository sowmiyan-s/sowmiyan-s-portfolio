...
const timeline = [
  { year: '2022', title: 'ACADEMIC START', desc: 'B.Tech AI & Data Science @ V.S.B. College of Engineering, Coimbatore.' },
  { year: '2023', title: 'AI FOUNDATIONS', desc: 'Developed multi-agent systems using CrewAI and LangChain frameworks.' },
  { year: '2024', title: 'RESEARCH & PUBLICATION', desc: 'Published "Cyber Crime" research in IJCRT and authored "Python for Beginners".' },
  { year: '2025', title: 'FULL STACK SCALE', desc: 'Building production-grade AWS deployments and large-scale React architectures.' },
];
