    ...
    <div className="relative min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <main className="relative z-10 pt-32 pb-24 px-6">
        ...
        >
          ...
          >
            <span className="text-[10px] opacity-40 font-mono tracking-[0.5em] uppercase">Project Readme from GitHub</span>
          ...
          >
            <div className="flex flex-col gap-1">
              <span className="text-[10px] font-mono opacity-40 uppercase tracking-widest">Repository Details</span>
              <span className="text-xs font-heading font-bold uppercase tracking-widest">{id}</span>
            </div>
          ...
          <div className="mt-12 flex justify-between items-center text-[10px] font-mono opacity-40">
            <span>PROJECT: {id?.toUpperCase()}</span>
            <span>© 2026 Sowmiyan S</span>
          </div>
        </motion.div>
      </main>
      <Footer />
