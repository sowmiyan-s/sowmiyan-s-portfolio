...
export interface AccordionGalleryProps {
  ...
  onItemClick?: (item: AccordionGalleryItem, index: number, e: React.MouseEvent) => void;
}
...
const AccordionGallery: React.FC<AccordionGalleryProps> = ({
  ...
  const handleClick = (i: number, e: React.MouseEvent<HTMLAnchorElement | HTMLDivElement>) => {
    if (i !== active) {
      e.preventDefault();
      setActive(i);
      onActiveChange?.(i);
