...
const MarqueeSection = () => {
    ...
    return (
        <section className="py-8 bg-transparent overflow-hidden relative border-none scale-105">
            <div className="w-[300vw] flex flex-nowrap items-center text-red-600" style={{ fontFamily: "'Waterfall', cursive" }}>
                <motion.div 
                    className="flex flex-nowrap whitespace-nowrap text-5xl md:text-7xl lg:text-8xl font-black bg-white inline-block py-2"
