...
const SkillsSection = () => {
    ...
    return (
        <section className="relative py-32 px-6 bg-transparent z-10 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto flex flex-col gap-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    ...
                    <div className="flex flex-col gap-8">
                        <h3 className="text-xl font-heading uppercase text-red-500 tracking-widest border-b border-white/10 pb-4">
                            Technical Skills
                        </h3>
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                            {techSkills.map((skill, index) => (
                                <motion.div 
                                    ...
                                    viewport={{ once: true }}
                                    className="p-4 border border-white/15 bg-black/60 backdrop-blur-sm hover:bg-red-950/20 hover:border-red-600 transition-all group relative overflow-hidden flex items-center justify-center text-center shadow-lg"
                                >
                                    <DecodeText text={skill} className="relative z-10 font-mono text-xs uppercase text-white font-bold group-hover:text-red-400 transition-colors tracking-widest" />
